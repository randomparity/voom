...
**YOU ARE IN: `voom/polecats/jasper/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/voom/` (rig root) or other directories
...
**Your mail address:** `voom/polecats/jasper`
**Your rig:** voom
**Your Witness:** `voom/witness`
...
| Ask Witness for help | `gt mail send voom/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`voom/witness`) when:
...
```bash
gt mail send voom/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
