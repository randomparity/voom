...
pub struct Track {
    ...
    pub loudness_integrated_lufs: Option<f64>,
    pub loudness_true_peak_db: Option<f64>,
    pub loudness_range_lu: Option<f64>,
    pub loudness_measured_at: Option<chrono::DateTime<chrono::Utc>>,
    // Video-specific
...
impl Default for Track {
    fn default() -> Self {
        Self {
            ...
            loudness_true_peak_db: None,
            loudness_range_lu: None,
            loudness_measured_at: None,
            width: None,
            height: None,
            frame_rate: None,
            is_vfr: false,
