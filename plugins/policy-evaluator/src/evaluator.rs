...
fn transcode_settings_from(s: &CompiledTranscodeSettings) -> TranscodeSettings {
    TranscodeSettings::default()
        ...
        .with_target_vmaf(s.target_vmaf)
        .with_max_bitrate(s.max_bitrate.clone())
        .with_min_bitrate(s.min_bitrate.clone())
        .with_sample_strategy(s.sample_strategy.clone())
        .with_fallback(s.fallback.clone())
        .with_vmaf_overrides(s.vmaf_overrides.clone())
        ...
        .with_preserve_hdr(s.preserve_hdr)
        .with_tonemap(s.tonemap.clone())
        .with_hdr_color_metadata(s.hdr_color_metadata.clone())
        .with_dolby_vision(s.dolby_vision.clone())
